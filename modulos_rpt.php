                                                ...
                                                <div class="box-body">
                                                        ...
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="list-group">
                                                                    <a href="modulos_rpt.php?opcion=1" class="list-group-item">Por Codigo</a>
                                                                    <a href="modulos_rpt.php?opcion=2" class="list-group-item">Por Descripción</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-8">
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">
                                                            <?php $modulos = consultas::get_datos("select * from modulos order by mod_cod");?>
                                                                <div class="form-group">
                                                                    <label class="control-label col-lg-3">Desde:</label>
                                                                    <div class="col-lg-6 col-md-5 col-sm-5">

                                                                        <select class="form-control select2" name="vdesde" required="">
                                                                            <?php foreach ($modulos as $modulos) { ?>
                                                                              <option value="<?php echo ($opcion==1)?$modulos['mod_cod']:$modulos['mod_nombre'];?>"><?php echo ($opcion==1)?$modulos['mod_cod']:$modulos['mod_nombre'];?></option>   
                                                                            <?php }?>
                                                                        </select>  
                                                                    </div>
                                                                </div>
