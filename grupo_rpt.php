                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            ?>
                                            <form action="grupo_print.php" method="get" accept-charset="utf-8" class="form-horizontal">
                                                ...
                                                <div class="box-body">
                                                        ...
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="list-group">
                                                                    <a href="grupo_rpt.php?opcion=1" class="list-group-item">Por Codigo</a>
                                                                    <a href="grupo_rpt.php?opcion=2" class="list-group-item">Por Descripción</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-8">
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">
                                                            <?php $grupo = consultas::get_datos("select * from grupos order by gru_cod");?>
                                                                    ...
                                                                    <div class="col-lg-6 col-md-5 col-sm-5">
                                                                        ...
                                                                        <select class="form-control select2" name="vdesde" required="">
                                                                            <?php foreach ($grupo as $grupo) { ?>
                                                                              <option value="<?php echo ($opcion==1)?$grupo['gru_cod']:$grupo['gru_nombre'];?>"><?php echo ($opcion==1)?$grupo['gru_cod']:$grupo['gru_nombre'];?></option>   
                                                                            <?php }?>
                                                                        </select>  
                                                                    </div>
                                                                </div>
