                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Reporte de Proveedor</h3>
                                </div>
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="list-group">
                                                                    ...
                                                                    <a href="proveedor_rpt.php?opcion=2" class="list-group-item">Por Descripción</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-6 col-md-5 col-sm-5">
                                                                        ...
                                                                        <select class="form-control select2" name="vdesde" required="">
                                                                            <?php foreach ($proveedor as $proveedor) { ?>
                                                                              <option value="<?php echo ($opcion==1)?$proveedor['prv_cod']:$proveedor['prv_razonsocial'];?>"><?php echo ($opcion==1)?$proveedor['prv_cod']:$proveedor['prv_razonsocial'];?></option>   
                                                                            <?php }?>
                                                                        </select>  
                                                                    </div>
                                                                </div>
