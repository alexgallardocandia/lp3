                            ...
                            >
                                <div class="box-header"><!--inicio header-->
                                    ...
                                    <div class="box-tools">
                                        ...
                                        <a target="new" href="sucursal_print.php" class="btn btn-default btn-sm"><i class="fa fa-print" data-title="Imprimir" rel="tooltip" data-placement="top"></i></a>
                                    </div>
                                </div><!--fin header-->
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <?php 
                                                ...
                                                $sucursales = consultas::get_datos("select * from sucursal "
                                                    ."where (id_sucursal||trim(upper(suc_descri))) "
                                                    ."like trim(upper('%".$valor."%')) order by id_sucursal");
                                            if (!empty($sucursales)) {?>
                                                    ...
                                                    <table class="table col-lg-12 col-md-12 col-sm-12 col-xs-12 tablo-bordered table-striped table-condensed">
                                                        ...
                                                        <tbody>
                                                            <?php foreach ($sucursales as $sucu) {?>
                                                                <tr>
                                                                    <td data-title="Descripcion"><?php echo $sucu['suc_descri']; ?></td>
                                                                    <td data-title="Aciones" class="text-center">
                                                                        <!-- boton editar -->
                                                                        <a onclick="editar(<?php echo "'". $sucu['id_sucursal']."_".$sucu['suc_descri']."'";?>)" class="btn btn-warning btn-sm" role="button" data-title="Editar" rel="tooltip" data-placement="top" data-toggle="modal" data-target="#editar"><span class="glyphicon glyphicon-edit"></span>
                                                                        </a>
                                                                        <!-- boton borrar -->
                                                                        <a onclick="borrar(<?php echo "'".$sucu['id_sucursal']."_".$sucu['suc_descri']."'" ; ?>)" class="btn btn-danger btn-sm" role="button" data-title="Borrar" rel="tooltip" data-placement="top" data-toggle="modal" data-target="#borrar"><span class="glyphicon glyphicon-trash"></span>
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                                            <?php } ?>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title"><b>AGREGAR SUCURSAL</b></h4>
                        </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="sucursal_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                            ...
                            <input id="cod" type="hidden" name="vid_sucursal"/>
                            <div class="box-body">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">DESCRIPCIÓN</label>
                                    <div class="col-sm-10">
                                        <input id="descri" type="text" name="vsuc_descri" class="form-control" required />
                                    </div>
                                </div>
                            </div>
                            <div class="box-footer">
...
<!--SCRIPTS MODALES-->
        ...
        //Borrar
            function borrar(datos){
                ...
                $('#confirmacion').html('<span class="glyphicon glyphicon-warning-sign"></span> \n Desea borrar el sucursal <i><b>'+dat[1]+'</b></i>?');
            }
        </script>
<!--FIN SCRIPTS MODALES-->
    </body>
