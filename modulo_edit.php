                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            >
                                <div class="box-header"><!--inicio header-->
                                    ...
                                    <div class="box-tools">
                                        <a href="modulo_index.php" class="btn btn-warning pull-right">
                                ...
                                <form action="modulo_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="vmod_nombre" class="form-control" value="<?php echo $resultado[0]['mod_nombre'];?>" required autofocus>
                                            </div>   
                                        </div>
                                    </div>
