                                                                    ...
                                                                    <div class="col-lg-6 col-md-5 col-sm-5">
                                                                        ...
                                                                        <select class="form-control select2" name="vdesde" required="">
                                                                            <?php foreach ($sucursal as $sucursal) { ?>
                                                                              <option value="<?php echo ($opcion==1)?$sucursal['id_sucursal']:$sucursal['suc_descri'];?>"><?php echo ($opcion==1)?$sucursal['id_sucursal']:$sucursal['suc_descri'];?></option>   
                                                                            <?php }?>
                                                                        </select>  
                                                                    </div>
                                                                </div>
