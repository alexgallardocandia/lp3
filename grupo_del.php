                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            >
                                <div class="box-header"><!--inicio header-->
                                    ...
                                    <div class="box-tools">
                                        <a href="grupo_index.php" class="btn btn-danger pull-right">
                                ...
                                <form action="grupo_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="vgru_nombre" class="form-control" value="<?php echo $resultado[0]['gru_nombre'];?>" disabled>
                                            </div>   
                                        </div>
                                    </div>
