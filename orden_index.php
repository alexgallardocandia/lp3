    ...
    <body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">ORDEN DE COMRPRA</h3>
                                    <div class="box-tools">
                                        <a href="orden_add.php" class="btn btn-primary btn-sm pull-right" data-title='Agregar' rel='tooltip' data-placement='top'><i class="fa fa-plus"></i> AGREGAR</a>
                                    </div>
                                </div>
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            $compras = consultas::get_datos("select * from v_orden where id_sucursal = "
                                            .$_SESSION['id_sucursal']." and orden_cod::varchar ilike '%".(isset($_REQUEST['buscar'])?$_REQUEST['buscar']:"")."%' order by orden_cod desc");
                                            //var_dump($marcas);
                                            if (!empty($compras)) { ?>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td data-title='Acciones' class="text-center">
                                                                ...
                                                                <?php }?>
                                                                <?php if($com['orden_estado']=="PENDIENTE" || $com['orden_estado']=="CONFIRMADO"){?>
                                                                <a onclick="anular(<?php echo "'".$com['orden_cod']."_".$com['prv_razonsocial']."_".$com['orden_fecha']."'"?>)" class="btn btn-danger btn-sm" role='button'
        ...
        <script>
            function anular(datos){
                ...
                $('#si').attr('href','compras_control.php?vorden_cod='+dat[0]+'&accion=3');
            ...
            function confirmar(datos){
                var dat = datos.split('_');
                $('#sic').attr('href','compras_control.php?vorden_cod='+dat[0]+'&accion=2');
