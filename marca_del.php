                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            >
                                <div class="box-header"><!--inicio header-->
                                    ...
                                    <div class="box-tools">
                                        <a href="marca_index.php" class="btn btn-danger pull-right">
                                ...
                                <form action="marca_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="vmar_descri" class="form-control" value="<?php echo $resultado[0]['mar_descri'];?>" disabled>
                                            </div>   
                                        </div>
                                    </div>
