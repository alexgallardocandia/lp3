                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                1" placeholder="Ingrese el RUC del proveedor"/>
                                            </div>
                                        </div> 
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <textarea class="form-control" name="vprv_direccion" placeholder="Ingrese la dirección del proveedor" required></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-lg-2">Telefono</label>
                                            <div class="col-lg-4">
                                                <input type="text" name="vprv_telefono" class="form-control" placeholder="Ingrese el telefono del proveedor" required/>
                                            </div>
                                        </div>                                     
                                    </div>
