                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            >
                                <div class="box-header"><!--inicio header-->
                                    ...
                                    <div class="box-tools">
                                        <a href="paginas_index.php" data-title="Volver" class="btn btn-warning pull-right">
                                ...
                                <form action="paginas_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" name="vpag_direc" class="form-control" value="<?php echo $resultado[0]['pag_direc']; ?>" required autofocus />
                                            </div>   
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-1 control-label">Nombre</label> 
                                            <div class="col-lg-8">
                                                <input type="text" name="vpag_nombre" class="form-control" value="<?php echo $resultado[0]['pag_nombre']; ?>" required autofocus />
                                            </div>   
                                        </div>      
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6 col-sm-12 col-xs-12 col-md-12">
                                                <select name="vmod_cod" class="form-control" required="">
                                                    <optgroup label="Elegido">
                                                        ...
                                                        <option value="<?php echo $resultado[0]['mod_cod']; ?>" selected><?php  echo $consul[0]['mod_cod']." ".$consul[0]['mod_nombre']; ?>
