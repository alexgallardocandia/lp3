...
<html>
    <head>
        ...
        <title>RECIBIR MERCADERIAS</title>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            >
                                <div class="box-header"><!--inicio header-->
                                    ...
                                    <h3 class="box-title">RECEPCION DE MERCADERIAS</h3>
                                </div><!--fin header-->
                                <div class="box-body no-padding">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <form action="recibir_index.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                                <div class="box-body">
                                            ...
                                            <?php
                                                ...
                                                $transferencias = consultas::get_datos("select * from v_transferencias "
                                                    ."where id_sucursal_destino=".$_SESSION['id_sucursal']." and (trans_cod||trim(upper(suc_descri))) "
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">
                                                                        <?php if($tra['trans_estado']=='PENDIENTE') { ?>
                                                                            <!--detalle-->
                                                                            <a onclick="confirmar(<?php echo "'".$tra['trans_cod']."_".$tra['id_sucursal_origen']."_".$tra['trans_fecha']."'"?>)" class="btn btn-info btn-sm" role='button'
...
<!--SCRIPTS MODALES-->
        ...
        <script>
            ...
            function confirmar(datos){
                var dat = datos.split('_');
                $('#sic').attr('href','recibir_control.php?vtrans_cod='+dat[0]+'&accion=2');
                $('#confirmacionc').html('<span class="glyphicon glyphicon-warning-sign"></span> Desea confirmar la \n\
                Transferencia N° <strong>'+dat[0]+'</strong> de fecha <strong>'+dat[2]+'</strong> de la sucursal de origen <strong>'+dat[1]+'</strong> ?');
            }
        </script>
<!--FIN SCRIPTS MODALES-->
