...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                ...
                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <?php }
                                $compras = consultas::get_datos("select * from v_orden where orden_cod=".$_REQUEST['vorden_cod']);
                            ?>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-condensed table-striped table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td data-title='N° de Orden'><?php echo $com['orden_cod'];?></td>
                                                            <td data-title='Fecha'><?php echo $com['orden_fecha'];?></td>
                                                            <td data-title='Proveedor'><?php echo $com['prv_razonsocial'];?></td>
                                                            <td data-title='Total'><?php echo number_format($com['orden_total'],0,",",".");?></td>
                                   ...
                                   <?php $pedidosdet = consultas::get_datos("select * from v_detalle_pedcompra where ped_com=".$compras[0]['ped_com']
                                                       ...
                                                       <?php foreach ($pedidosdet as $peddet) { ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a onclick="add(<?php echo $peddet['ped_com'];?>,<?php echo $compras[0]['orden_cod'];?>,<?php echo $peddet['art_cod'];?>,<?php echo $peddet['dep_cod'];?>)" class="btn btn-success btn-sm" role='button'
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <?php }else{ ?>
                                            <div class="alert alert-info flat">
                                                <i class="fa fa-info-circle"></i> La orden aún no tiene detalles cargados...
                                            </div>
                                            <?php } ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                            <form action="orden_dcontrol.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                                ...
                                                <input type="hidden" name="vorden_cod" value="<?php echo $compras[0]['orden_cod'];?>">
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-3 col-md-4 col-sm-4">
                                                            <input type="number" class="form-control" name="vorden_cant" min="1" value="1" required=""/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-lg-2">Precio:</label>
                                                        <div class="col-lg-3 col-md-4 col-sm-4">
                                                            <input type="number" class="form-control" name="vorden_precio" min="1" required="" id="vprecio"/>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        function editar(com,art,dep){
            $.ajax({
                type    : "GET",
                url     : "/taller/orden_dedit.php?vorden_cod="+com+"&vart_cod="+art+"&vdep_cod="+dep,
                cache   : false,
                beforeSend:function(){
        ...
        function borrar(datos){
            ...
            $('#si').attr('href','orden_dcontrol.php?vorden_cod='+dat[0]+'&vart_cod='+dat[1]+'&vdep_cod='+dat[2]+'&accion=3');
    ...
    <strong>'+dat[3]+'</strong> ?');
        ...
        function add(ped,ven,art,dep){
            $.ajax({
                type    : "GET",
                url     : "/taller/orden_dadd.php?vped_com="+ped+"&vorden_cod="+ven+"&vart_cod="+art+"&vdep_cod="+dep,
                cache   : false,
                beforeSend:function(){
                   $("#detalles").html('<img src="img/loader.gif"/><strong>Cargando...</strong>')
                },
