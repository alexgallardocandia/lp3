    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4 col-md-4 col-lg-4">
                <input type="number" name="vorden_cant" class="form-control" required="" value="<?php echo $detalles[0]['orden_cant']?>" min="1"/>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-sm-2">Precio:</label>
            <div class="col-sm-4 col-md-4 col-lg-4">
                <input type="number" name="vorden_precio" class="form-control" required="" value="<?php echo $detalles[0]['orden_precio']?>" min="1"/>
            </div>
        </div>
    </div>
