...
<html>
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="img/Copyright.png">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            >
                                <div class="box-header"><!--inicio header-->
                                    ...
                                    <div class="box-tools">
                                        <a href="marca_index.php" class="btn btn-warning pull-right">
                                ...
                                <form action="marca_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="vmar_descri" class="form-control" value="<?php echo $resultado[0]['mar_descri'];?>" required autofocus>
                                            </div>   
                                        </div>
                                    </div>
