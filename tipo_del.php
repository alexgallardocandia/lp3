                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            >
                                <div class="box-header"><!--inicio header-->
                                    ...
                                    <h3 class="box-title">Borrar Impuesto</h3>
                                    <div class="box-tools">
                                        <a href="tipo_index.php"  data-title="Volver" class="btn btn-danger pull-right">
                                ...
                                <form action="tipo_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input  type="text" name="vtipo_descri" class="form-control" value="<?php echo $resultado[0]['tipo_descri'];?>" readonly onmousedown="return false;"/>    
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-1 control-label">Porcentaje</label>
                                            <div class="col-lg-8">
                                                <input  type="number" name="vtipo_porcen" class="form-control" value="<?php echo $resultado[0]['tipo_porcen'];?>" readonly onmousedown="return false;">    
                                            </div>
                                        </div>
                                    </div>
