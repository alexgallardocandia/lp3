                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Reporte de Articulos</h3>
                                </div>
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">
                                                            <?php $articulo = consultas::get_datos("select * from v_articulo order by art_cod");?>
                                                                    ...
                                                                    <div class="col-lg-6 col-md-5 col-sm-5">
                                                                        ...
                                                                        <select class="form-control select2" name="vdesde" required="">
                                                                            <?php foreach ($articulo as $articulo) { ?>
                                                                              <option value="<?php echo ($opcion==1)?$articulo['art_cod']:$articulo['art_descri'];?>"><?php echo ($opcion==1)?$articulo['art_cod']:$articulo['art_descri'];?></option>   
                                                                            <?php }?>
                                                                        </select>  
                                                                    </div>
                                                                </div>
