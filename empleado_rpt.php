                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">
                                                            <?php $empleado = consultas::get_datos("select * from v_empleado order by emp_cod");?>
                                                                    ...
                                                                    <div class="col-lg-6 col-md-5 col-sm-5">
                                                                        ...
                                                                        <select class="form-control select2" name="vdesde" required="">
                                                                            <?php foreach ($empleado as $empleado) { ?>
                                                                              <option value="<?php echo ($opcion==1)?$empleado['emp_cod']:$empleado['emp_nombre'];?>"><?php echo ($opcion==1)?$empleado['emp_cod']:$empleado['emp_nombre'];?></option>   
                                                                            <?php }?>
                                                                        </select>  
                                                                    </div>
                                                                </div>
