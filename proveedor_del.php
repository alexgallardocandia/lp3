	                        ...
	                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                            ...
	                            <div class="box box-danger">
	                                <div class="box-header"><!--inicio header-->
	                                    ...
	                                    <div class="box-tools">
	                                    	<a href="proveedor_index.php" class="btn btn-danger pull-right"> <i class="fa fa-arrow-left" data-title="Volver" rel="tooltip" ></i></a>
	                                    </div>
	                                </div><!--fin header-->
									<form action="proveedor_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                1" placeholder="Ingrese el RUC del proveedor" value="<?php echo $resultado[0]['prv_ruc'] ?>" disabled>
                                            </div>
                                        </div> 
                                        <div class="form-group">
                                            <label class="control-label col-lg-2">Razon Social</label>
                                            <div class="col-lg-6">
                                                <input type="text" name="vprv_razonsocial" class="form-control" required="" placeholder="Ingrese la Razon Social del proveedor" value="<?php echo $resultado[0]['prv_razonsocial'] ?>" disabled/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-lg-2">Dirección</label>
                                            <div class="col-lg-6">
                                                <textarea class="form-control" name="vprv_direccion" placeholder="Ingrese la dirección del proveedor"  disabled><?php echo $resultado[0]['prv_direccion'] ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-lg-2">Telefono</label>
                                            <div class="col-lg-4">
                                                <input type="text" name="vprv_telefono" class="form-control" placeholder="Ingrese el telefono del proveedor" value="<?php echo $resultado[0]['prv_telefono'] ?>" disabled/>
                                            </div>
                                        </div>                                      
                                    </div>
